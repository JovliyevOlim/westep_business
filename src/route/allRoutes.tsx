...
import Professions from "../pages/Dashboard/Professions.tsx";
import ProfessionEditor from "../pages/Dashboard/ProfessionEditor.tsx";
...
export const authProtectedRoutes = [
    ...
    {path: "/professions/create", element: <ProfessionEditor/>},
    {path: "/professions/:id/edit", element: <ProfessionEditor/>},
