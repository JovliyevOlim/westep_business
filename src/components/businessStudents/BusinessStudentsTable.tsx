    ...
    return (
        <div className="hidden overflow-x-auto lg:block">
            <div className="min-w-[1120px] px-4 pb-6">
                <div className="grid grid-cols-[2fr_2.1fr_1.1fr_0.9fr_0.9fr] gap-4 border-b border-slate-200 px-2 py-5 text-sm font-semibold text-slate-700 dark:border-slate-800 dark:text-slate-200">
                ...
                <div className="space-y-2 pt-2">
                    {students.map((student) => (
                        <div
                            ...
                            className="grid w-full grid-cols-[2fr_2.1fr_1.1fr_0.9fr_0.9fr] gap-4 rounded-2xl px-2 py-6 text-left transition hover:bg-white/70 dark:hover:bg-white/[0.03]"
                        >
